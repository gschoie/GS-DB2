...
지난 한 주의 데일리 브리핑들을 종합해, HD현대건설기계·HD현대인프라코어·두산밥캣을 커버하는 애널리스트가 주말에 한 번에 읽는 주간 정리본을 작성합니다.
...
3. ## 수주·계약·전략 — 이번 주 확정·진전된 수주/계약/신제품/딜러망/공장투자/M&A를 목록으로 (지역 | 내용 | 업체 | 규모 | 날짜). 한국 3사 관련 건은 빠짐없이. 각 행은 " | " 구분 일반 텍스트 줄로 (마크다운 표 문법 |---| 금지)
4. ## 주간 주가 리뷰 — [확정 주간 시세표] 기준. 주간 상승·하락 상위와 배경을 데일리 브리핑의 뉴스로 연결. ±15% 이상은 반드시 별도 설명. 한국 3사는 변동이 작아도 언급
5. ## 시장별 동향 — 미국(주택·인프라·렌탈) / 유럽 / 중국(굴착기·부동산·부양책) / 자원국·광산 / 신흥국(인도·아세안) 순. 이슈 없는 시장은 생략 가능
6. ## 한국 3사 종합 — HD현대건설기계·HD현대인프라코어·두산밥캣 관련 한 주 소식과 경쟁 구도(특히 중국 업체) 관점의 평가
