...
UNIVERSE = [
    # 한국 — 커버리지의 중심
    ("267270.KS", "HD현대건설기계 (HD Hyundai CE)", "한국", "종합"),
    ("042670.KS", "HD현대인프라코어 (HD Hyundai Infracore)", "한국", "종합"),
...
# 자원국 광산 capex / 신흥국) + 기업(한국 3사·글로벌 피어·중국 업체) + 정책·통상.
...
매일 아침 한국의 건설기계 담당 애널리스트(HD현대건설기계·HD현대인프라코어·두산밥캣 커버)에게 보내는 데일리 브리핑을 작성합니다.
...
- **뉴스의 함의를 끝까지 해석하세요.** 특히 경쟁 구도: 중국 업체(SANY·XCMG·Zoomlion·LiuGong)의 신흥국·자원국 수주나 딜러망 확대는 같은 시장에서 경쟁하는 한국 업체(HD현대건설기계·HD현대인프라코어·두산밥캣)의 점유율 위협을 의미할 수 있습니다. 광산 capex 확대는 대형 굴착기·광산트럭 수요, 미국 주택 회복은 소형장비(두산밥캣) 수요로 연결하세요. 수혜 기업과 피해 기업을 모두 짚으세요.
...
3. ## 주요 주가 동향 — 기업명 | 국가 | 종가 기준 등락률 | 시총 | 변동 요인. 변동폭이 크거나 뉴스가 있는 종목 위주로 15개 내외. 한국 3사는 변동이 작아도 반드시 포함. 각 행은 "기업명 | 국가 | +x.xx% | 시총 | 요인" 형태의 일반 텍스트 줄로 쓰세요 (마크다운 표 문법 |---| 사용 금지).
...
6. ## 기업 전략 동향 — 신제품·전동화 / 딜러망·유통 / 생산·공장 / M&A 관점의 기업 소식. 한국 3사 관련 함의가 있으면 반드시 명시
7. ## 투자 시사점 — 단기 촉매와 중기 업황 관점 3개 이내. HD현대건설기계·HD현대인프라코어·두산밥캣 관점 포함
